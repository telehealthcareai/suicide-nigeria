...
Nigerian_suicide_cases = suicide_data[suicide_data["GEO_NAME_SHORT"] == "Nigeria"].copy()
...
def update_plot(selected_gender):
    if selected_gender == "TOTAL":
        ...
        filtered_data = Nigerian_suicide_cases[Nigerian_suicide_cases["Gender"] == selected_gender]
